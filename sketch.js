...
function setup() {
  ...
  trex = createSprite(50,height-25);
  ...
  invisibleGround = createSprite(width/2,height-14,width,5);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width,height+20);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(width,height-37);
    //obstacle.debug = true;
